...
public class BDao {
	...
	public void write(String bname, String btitle, String bcontent) {
		...
		try {
			conn = DBCon.getConnection();
			String query = "insert into replyboard(bid,bname,btitle," + "bcontent,bdate,bhit,bgroup,bstep,bindent) "
	...
	public void modify(String bid, String bname, String btitle, String bcontent) {
		...
		try {
			conn = DBCon.getConnection();
			String query = "update replyboard " + "set bname=?,btitle=?,bcontent=? " + "where bid=?";
